...
CREATE TABLE IF NOT EXISTS `ACTIVIDAD` (
  ...
  `NM_ACTIVIDAD` varchar(150) DEFAULT NULL,
...
-- Volcando estructura para tabla xualidb.COMPETENCIA
CREATE TABLE IF NOT EXISTS `COMPETENCIA` (
  `ID_COMPETENCIA` int(11) NOT NULL DEFAULT '0',
  `ID_TEMA` int(11) DEFAULT NULL,
  `DS_COMPETENCIA` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`ID_COMPETENCIA`),
  KEY `COMPETENCIA_TEMA` (`ID_TEMA`),
  CONSTRAINT `COMPETENCIA_TEMA` FOREIGN KEY (`ID_TEMA`) REFERENCES `TEMA` (`ID_TEMA`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `HISTORIA` (
  ...
  `ID_COMPENTENCIA` int(11) DEFAULT NULL,
  `CD_TYPE` varchar(20) DEFAULT NULL,
  `TITLE_HISTORIA` varchar(250) DEFAULT NULL,
  `DS_HISTORIA` text,
  `URL_HISTORIA` int(11) DEFAULT NULL,
  `PUNTO_DECISION` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID_HISTORIA`),
  KEY `HISTORIA_COMPETENCIA` (`ID_COMPENTENCIA`),
  CONSTRAINT `HISTORIA_COMPETENCIA` FOREIGN KEY (`ID_COMPENTENCIA`) REFERENCES `COMPETENCIA` (`ID_COMPETENCIA`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `NIVEL_COMPETENCIA` (
  ...
  CONSTRAINT `NIVEL_COMP_COMPETENCIA` FOREIGN KEY (`ID_COMPETENCIA`) REFERENCES `COMPETENCIA` (`ID_COMPETENCIA`),
...
CREATE TABLE IF NOT EXISTS `PUNTO_DECISION` (
  ...
  KEY `DESICION_HISTORIA1` (`ID_HISTORIA_1`),
  KEY `DESICION_HISTORIA2` (`ID_HISTORIA_2`),
  CONSTRAINT `DESICION_HISTORIA1` FOREIGN KEY (`ID_HISTORIA_1`) REFERENCES `HISTORIA` (`ID_HISTORIA`),
  CONSTRAINT `DESICION_HISTORIA2` FOREIGN KEY (`ID_HISTORIA_2`) REFERENCES `HISTORIA` (`ID_HISTORIA`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `TEMA` (
  ...
  PRIMARY KEY (`ID_TEMA`),
  KEY `TEMA_COMPONENTE` (`ID_COMPONENTE`),
  CONSTRAINT `TEMA_COMPONENTE` FOREIGN KEY (`ID_COMPONENTE`) REFERENCES `COMPONENTE` (`ID_COMPONENTE`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
